...
export const highlightDir = app =>  app.directive('highlight',function (el) {
...
export const addCopyCode = app =>  app.directive('copy',function (el) {
  let blocks = el.querySelectorAll('pre code');
  blocks.forEach((block, index) =>{
    if (['code'.toUpperCase()].includes(block.tagName)) {
      block.setAttribute(`js-code-block`, index)
